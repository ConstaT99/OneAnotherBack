...
Called when adding a comment that is replying to a productSell.
A helper function for a productSell to track its child comments
Input {
    productId: the id of the parent productSell being updated,
    toAddId: the id of the child comment to be tracked
}
Output {
    the child comment id should be added into the parent productSell's repliedBy array
}
*/
