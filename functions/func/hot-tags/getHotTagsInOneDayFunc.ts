...
/*
Author @Carstin
get twenty hot tags which updated within 1 day
Input {
    none
}
Output {
...
export const getHotTagsInOneDay = async () => {
  const currenttime = Math.floor(Date.now() / 1000);
  const time = currenttime - 86400;
...
export default functions.https.onCall(getHotTagsInOneDay);
